  ...
  return (
    <section className="surface-card">
      <div className="panel-head">
        ...
        <p>
          {hasResult
            ? "생성된 소개서를 바로 열어보고 PDF나 인쇄 형태로 고객에게 전달할 수 있습니다."
            : "소개서를 생성하면 최종 소개서 보기와 PDF 저장, 인쇄 기능이 활성화됩니다."}
        </p>
      </div>
      ...
      {hasResult ? (
        <>
          ...
          <div className="result-tip">
            고객 전달용 소개서에는 입력 폼이나 내부 수집 정보가 포함되지 않고, 소개서 내용만 깔끔하게 정리됩니다.
          </div>
        ...
        <div className="empty-box result-empty-box">
          ...
          <p>미리보기를 확인한 뒤 소개서 생성 버튼을 누르면 최종 소개서 보기와 PDF 저장을 바로 사용할 수 있습니다.</p>
        </div>
      )}
    </section>
  );
